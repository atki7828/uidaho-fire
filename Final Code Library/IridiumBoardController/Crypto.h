...
#define getSBoxValue(num) (sbox[(num)]) // Defines method to retrieve substitution box value
#define getSBoxInvert(num) (rsbox[(num)]) // Defines method to retrieve the inverse substitution box value
...
class Crypto
{
    public:
        // Methods:
        Crypto();
        void init(); // Called to initialize all variables
        uint8_t* encrypt_cbc(String str);
